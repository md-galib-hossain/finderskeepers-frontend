...
import {
  ...
  import ViewFullClaimItemModal from './MyClaimItemModal'
...
import ClaimsOnMyItemModal from "./ClaimsOnMyItemModal.";
  
  const ClaimsOnMyItemCard = ({ claimItem }: { claimItem: any }) => {
          ...
          <CardContent>
            ...
            <Typography variant="body2" color="text.secondary">
              <Box display="flex" alignItems="center">
                ...
                <Tooltip title={claimItem?.distinguishingFeatures || ""}>
                  <Typography display="inline" noWrap>
                    {truncateText(claimItem?.distinguishingFeatures || "", maxTextLength)}
                  </Typography>
                </Tooltip>
              </Box>
            </Typography>
  ...
  export default ClaimsOnMyItemCard;
